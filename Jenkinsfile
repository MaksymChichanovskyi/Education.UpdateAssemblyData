...
visualstudio.windowsApp(String solutionPath = 'Education.UpdateAssemblyData.sln', String configuration = 'Release', String csprojPath= 'UpdateAssemblyData\Education.UpdateAssemblyData.csproj')
